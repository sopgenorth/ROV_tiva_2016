...
/*
 * 5th order Butterworth filter. With a 200Hz sample rate, and 90Hz corner frequency.
 * Autogenerated from: http://www.schwietering.com/jayduino/filtuino/index.php
 */
//Low pass butterworth filter order=5 alpha1=0.45 
//Low pass butterworth filter order=5 alpha1=0.25 
class  FilterBuLp5
{
public:
  FilterBuLp5()
...
public:
  float step(float x) //class II 
  {
    ...
    v[3] = v[4];
    v[4] = v[5];
    v[5] = (5.278640450004203760e-2 * x)
      + (0.00000000000000000309 * v[0])
        + (-0.05572809000084121694 * v[1])
          + (0.00000000000000013044 * v[2])
            + (-0.63343685400050475653 * v[3])
              + (0.00000000000000040563 * v[4]);
    return 
      (v[0] + v[5])
      +5 * (v[1] + v[4])
        +10 * (v[2] + v[3]);
